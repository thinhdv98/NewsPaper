...
import com.duan2.thinh.newspaper.ui.fragment.dantri.adapter.DanTriVHAdapter;
import com.duan2.thinh.newspaper.ui.fragment.dantri.model.DanTri_VH_Content;
...
//                    Document document = Jsoup.connect("http://m.dantri.com.vn/van-hoa.htm")
                    ...
                    Document document = Jsoup.connect("https://dulich.tuoitre.vn").userAgent("Mozilla/5.0 (Linux; Android 7.0; PLUS Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.98 Mobile Safari/537.36")
                            .get();
                    ...
                    for (Element element : elements) {
                        ...
                        String linkd = "https://dulich.tuoitre.vn" + link;
